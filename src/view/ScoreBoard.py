...
Clase Scoreboard
######################
Muestra los puntajes históricos de jugadores que decidieron guardarlos.
"""
import wx
...
class PointList(wx.Panel):
    """
    Panel que contiene una grilla con los nombres y puntajes de los jugadores
    :param parent: clase padre
    """
